...
test("homepage keeps the original website logo favicon", async () => {
  const home = await readText("github-pages/index.html");
  assert.match(home, /<link rel="icon" type="image\/png" sizes="96x96" href="\/khien-so-logo\.png" \/>/);
  assert.match(home, /<link rel="apple-touch-icon" href="\/khien-so-logo\.png" \/>/);
});
