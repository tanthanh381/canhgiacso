...
test("QC Wave 3 runs immediately after Wave 2 before the SEO authority wave", () => {
  assert.match(
    ...
    /patch-qc-wave2\.mjs && node scripts\/patch-qc-wave3\.mjs && node scripts\/patch-seo-authority-wave6\.mjs && node scripts\/patch-seo-intent-wave7\.mjs && node scripts\/patch-seo-ctr-wave8\.mjs && node scripts\/patch-realtime-analytics\.mjs/,
  );
});
